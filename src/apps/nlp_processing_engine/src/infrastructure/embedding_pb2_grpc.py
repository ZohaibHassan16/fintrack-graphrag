...
class EmbeddingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateEmbedding = channel.unary_unary(
                '/enterprise.fintrack.EmbeddingService/GenerateEmbedding',
        ...
        self.GenerateAnswer = channel.unary_stream(
                '/enterprise.fintrack.EmbeddingService/GenerateAnswer',
                request_serializer=embedding__pb2.RAGRequest.SerializeToString,
                response_deserializer=embedding__pb2.RAGResponse.FromString,
                _registered_method=True)
...
class EmbeddingServiceServicer(object):
    ...
    def GenerateAnswer(self, request, context):
        """NEW: Generation Phase (Streaming)
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_EmbeddingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GenerateAnswer': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=embedding__pb2.RAGRequest.FromString,
                    response_serializer=embedding__pb2.RAGResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'enterprise.fintrack.EmbeddingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('enterprise.fintrack.EmbeddingService', rpc_method_handlers)
...
class EmbeddingService(object):
    ...
    def GenerateAnswer(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/enterprise.fintrack.EmbeddingService/GenerateAnswer',
            embedding__pb2.RAGRequest.SerializeToString,
            embedding__pb2.RAGResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
